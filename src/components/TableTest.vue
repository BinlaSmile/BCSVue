<template>
  <div class="layout">
    <Layout>
      ...
      <Footer class="layout-footer-center"> Binla</Footer>
    </Layout>
  </div>
</template>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {field: 'id', title: 'id', width: 150, titleAlign: 'center', columnAlign: 'center',isResize:true}
        ]
      }
    },
    created() {
      this.$ajax('http://localhost:8088/user/1').then(res => {
